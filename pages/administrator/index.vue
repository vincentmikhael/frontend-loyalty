                    ...
                    <div class="card p-4">
                        <div class="d-flex justify-content-center align-items-center gap-2">
                            <span class="fa-stack fa-2x">
                                <i style="color: #2C2D36;" class="fa-solid fa-square fa-stack-2x"></i>
                                <i class="fa-solid fa-user fa-stack-1x fa-inverse"></i>
                            </span>
               
                            <div class="">
                                <h1 class="mb-0">{{data.userTotal}}</h1>
                                <div>Member</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-floating form-dark">
                                        <input v-model="formdata.id_number" type="text" class="form-control"
                                            id="floatingPassword" placeholder="ID Number" />
                                    ...
                                    <div class="form-floating form-dark">
                                        <input v-model="formdata.birthdate" type="date" class="form-control"
                                            id="floatingPassword" placeholder="Birthdate" />
                                        <label for="floatingPassword">Birthdate</label>
                                    </div>
                                    <div class="ms-3">
                                        <p class="mt-4">Gender</p>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" v-model="formdata.gender"
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" v-model="formdata.blood_type"
                                    ...
                                    <div class="form-floating form-dark">
                                        <input v-model="formdata.sport_enthusiast" type="text" class="form-control"
                                            id="floatingPassword" placeholder="Sport Enthusiast" />
                                ...
                                <div class="col-6">
                                    <div class="form-floating form-dark">
                                        <input disabled v-model="formdata.level" type="text" class="form-control"
                                            id="floatingPassword" placeholder="Address" />
                            ...
                            <button v-show="!isEdit" @click="register" type="button" id="signin"
                                class="btn btn-outline-light p-2 mt-5 px-4">SIGN UP</button>
                            <button v-show="isEdit" @click="handleEdit" type="button" id="signin"
                                class="btn btn-outline-light p-2 mt-5 px-4">Save</button>
                        </form>
...
export default {
    ...
    async fetch() {
        let res = await this.$api.get('user/get')
        this.data.userTotal = res.data.totalRows
